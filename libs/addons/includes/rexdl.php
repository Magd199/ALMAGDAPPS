    ...
    <div class="containerX">
        <div class="tab-content">
            ...
            <div id="menu1" class="tab-pane fade">
                ...
                <p>
                    ...
                    function apkhome_games() {
                        // create HTML DOM
                        $html = file_get_html('https://rexdl.com/android/game/', LIBXML_NOERROR);
                        // get article block //a/dl/dd[@class='d1']/text() dd class="d1"
        ...
        $ret[] = $item;
                    ...
                    foreach($ret as $GP_) {
                        ...
                        echo '<span class="play_rating" style="float:right;"><a ><i class="fa fa-eye"></i> view</a></span>';
                        echo '</div>';
            ...
            <div id="menu2" class="tab-pane fade">
                ...
                <p>
                    ...
                    function apkhome_apps() {
                        // create HTML DOM
                        $html = file_get_html('https://rexdl.com/android/app/', LIBXML_NOERROR);
                        // get article block //a/dl/dd[@class='d1']/text() dd class="d1"
                         foreach($html->find("//article") as $article) {
        // get title
        $item['title'] = trim($article->find('h2', 0)->{'plaintext'});
        ...
        $ret[] = $item;
            ...
            <div id="menu3" class="tab-pane fade">
				...
				<li>Open website <a style="color:#1e73be" href="https://rexdl.com" target="_blank">rexdl.com</a></li>
				<li>Copy link post and paste to form</li>				 
				<li>use the url into this format: <strong style="color:#1e73be;text-transform:lowercase!important">https://rexdl.com/android/house-flipper-home-design-apk.html/</strong> </li>
                ...
                <form name="myForm" id="myForm" method="POST">
                    <input  class="apkextractor" type="text" name="wp_url"  placeholder="example : https://rexdl.com/android/house-flipper-home-design-apk.html/" onkeypress="this.style.width =((this.value.length + 1) * 8) + 'px';" >
