            ...
            if(stristr($url, $sources)) {
                ...
                if(count($gets_data) AND !isset($gets_data['error'])) {
                    ...
                    */
                    ...
                    add_post_meta( $post_id, 'wp_mods2', $mods_alt_desc );
                   ...
                   /*  $mods = implode(", ", $modsX );
                    ...
                    if($post_id)
                        $urlX = get_post_permalink( $post_id );
        ...
        <div class="tab-content">
            ...
            <div id="menu1" class="tab-pane fade">
               ...
               <?php
                    ...
                    $host2 = $host;
                    $host3 = $host;
                    $sumbers = 'https://apkdown.cc/'; 
                    $target1 = 'https://apkdown.cc';
                    $target2 = 'apkdown.cc';
            ...
            <div id="menu2" class="tab-pane fade">
               ...
               <?php
                    ...
                    $host2 = $host;
                    $host3 = $host;
                    $sumbers = 'https://apkdown.cc/apps-android/'; 
                    $target1 = 'https://apkdown.cc';
                    $target2 = 'apkdown.cc';
            ...
            <div id="menu4" class="tab-pane fade">
               ...
               <?php
                    ...
                    $host2 = $host;
                    $host3 = $host;
                    $sumbers = 'https://apkdown.cc/games-android/'; 
                    $target1 = 'https://apkdown.cc';
                    $target2 = 'apkdown.cc';
