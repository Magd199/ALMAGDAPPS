        ...
        <div class="tab-content">
            ...
            <div id="menu1" class="tab-pane fade">
                ...
                <div class="play_result" >
                    ...
                    $host2 = $host;
                    $host3 = $host;
                    $sumbers = 'https://www.happymod.com/new-mod.html'; 
                    $target1 = 'https://happymod.com';
                    $target2 = 'happymod.com';
					$happymod =  file_get_contents($sumbers, false, stream_context_create($ssl));
                    $happymod =  file_get_contents($sumbers, false, stream_context_create($ssl));
                    $happymod =  str_ireplace('/static/', $target1.'/static/', $happymod);  
                    $happymod =  preg_replace('#<img.*?data-original="(.*?)".*?alt="(.*?)">#si', '<img src="$1" title="$2">', $happymod); 
                    $happymod =  preg_replace('#<link rel="alternate".*?>#si', PHP_EOL, $happymod);
                    $happymod =  preg_replace("#<link rel='dns-prefetch'.*?>#si", PHP_EOL, $happymod);
                    $happymod =  preg_replace('#<script.*?>.*?</script>#si', PHP_EOL, $happymod);
                    $happymod =  preg_replace('#<meta.*?>#si', PHP_EOL, $happymod); 
					
					$happymod =  preg_replace('#<header.*?</header>#si', '', $happymod);
					$happymod =  preg_replace('#<div class="container-right">.*?<footer class="footer">#si', '<footer class="footer">', $happymod);
					$happymod =  preg_replace('#<footer class="footer">.*?</body>#si', '</body>', $happymod);
                    $happymod =  str_ireplace('<div class="container-left">', '<link rel="stylesheet" type="text/css" href="https://happymod.com/static/css/page.css?1.06"/>
					<div class="containers" style="width: 100% !important;margin-right: 2px !important;">', $happymod);  
					$happymod =  preg_replace('#<div class="page">.*?</div>#si', '', $happymod);
					$happymod =  preg_replace('#<div class="left-nav">.*?<div class="container-row clearfix container-wrap">#si', '<div class="container-row clearfix container-wrap">', $happymod);
                   /*  $happymod =  str_ireplace('</body>', '</div></body>', $happymod);   */
					$happymod =  preg_replace('#<p class="pdt-list-p">.*?<div class="pdt-list-right">#si', '</div><div class="pdt-list-right">', $happymod);
					$happymod =  preg_replace('#<p class="pdt-list-right-p">.*?<p class="clearfix">#si', '<p class="clearfix">', $happymod);
					$happymod =  preg_replace('#<div class="title-box">.*?</div>#si', '', $happymod);
					$happymod =  preg_replace('#<head>.*?</head>#si', '', $happymod);
                    $happymod =  str_ireplace('<!DOCTYPE html>', '' , $happymod);  
                    $happymod =  str_ireplace('<html>', '' , $happymod);  
                    $happymod =  str_ireplace('<body class="body-bg">', '' , $happymod);  
                    $happymod =  str_ireplace('</body>', '' , $happymod);  
                    $happymod =  str_ireplace('</html>', '' , $happymod);  
                    $happymod =  str_ireplace('<section class="section-page-white">', '<section class="section-page-whites" style="padding: 10px;background: #fff;margin: unset;border: none;">' , $happymod); 			 
					$happymod =  preg_replace('#<h3 class="pdt-list-h3"><a href=".*?">(.*?)</a></h3>#si', '<h3 class="pdt-list-h3">$1</h3>', $happymod); 
					$happymod =  preg_replace('#<p class="clearfix">.*?<a href="(.*?)" class="pdt-list-right-btn">Download</a>.*?</p>#si', '<p class="clearfix"><form name="myForm" id="myForm" method="POST"><input style="display:none" type="text" name="wp_url" value="'.$target1.'$1"  /><input type="submit" id="Submit" name="wp_sb" class="button-primary abe2" value="Post Now" /></form></p>', $happymod);		
              ...
              <div class="play_menu" style="text-transform:uppercase">
				...
				<li>Open website <a style="color:#1e73be" href="https://www.happymod.com/new-mod.html" target="_blank">happymod.com</a></li>
				<li>Copy link post and paste to form</li>
				<li>use the url into this format: <strong style="color:#1e73be;text-transform:lowercase!important">https://www.happymod.com/drive-mod/com.pixelperfectdude.htdrive/</strong> </li>
				</ol>
				</div>
				<div class="play_menu" >
				...
				<div class="play_menu" >
				<form method="POST">
					<input class="apkextractor" type="text" name="wp_url" onkeypress="this.style.width =((this.value.length + 1) * 8) + 'px';"  placeholder="example : https://www.happymod.com/drive-mod/com.pixelperfectdude.htdrive/">
					<input type="submit" name="wp_sb" class="button-primary" value="<?php echo postnow2 ?>" />
				</form>
				</div>
