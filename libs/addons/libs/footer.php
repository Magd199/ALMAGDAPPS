...
<div class="play_menu">
<i class="fa fa-globe"></i>&nbsp;<a href="<?php echo ''.webs.'' ?>" target="_blank"><?php echo ''.BY.'' ?></a>&nbsp;&nbsp;
<i class="fa fa-facebook-official"></i>&nbsp;<a href="<?php echo ''.FB.'' ?>" target="_blank"><?php echo ''.BY.'' ?></a>&nbsp;&nbsp;
<i class="fa fa-twitter-square"></i>&nbsp;<a href="<?php echo ''.TW.'' ?>" target="_blank"><?php echo ''.BY.'' ?></a>&nbsp;&nbsp;
<i class="fa fa-youtube-square"></i>&nbsp;<a href="<?php echo ''.YT.'' ?>" target="_blank"><?php echo ''.BY.'' ?></a>&nbsp;&nbsp;
<i class="fa fa-instagram"></i>&nbsp;<a href="<?php echo ''.IG.'' ?>" target="_blank"><?php echo ''.BY.'' ?></a>&nbsp;&nbsp;
</div>
<script>
...
<style> 
input.apkextractor::placeholder {color: grey!important;opacity: 5; }
</style>