...
Redux::setSection( $opt_name, array(
	...
	array(
        ...
        array(
            ...
            'desc'     => __('<i>* Select for Language</i>', THEMES_NAMES), 
            'options'  => array(
        ...
        array(
            ...
            'desc'				=> __('Select for Status Post <br><i>Draft or Publish * <b>Publish</b> to auto post</i>', THEMES_NAMES), 
            'options'  => array(
                'draft' => 'Draft',
                'publish' => 'Publish'
            ),
        ...
        array(
            ...
            'desc'				=> __('Select for Title Post  <br><i>* Title Mods or Title App Name PlayStore</i>', THEMES_NAMES), 
            'options'  => array(
                'title' => 'Title Mods',
        ...
        array(
            ...
            'desc'				=> __('Select for Permalink Post  <br><i>* Permalink Title with Mods or Permalink Title from App Name</i>', THEMES_NAMES), 
            'options'  => array(
        ...
        array(
            ...
            'desc'				=> __( '<code>on</code> to use Title from App Name', THEMES_NAMES ), 
            'default'			=> false
        ),
		/* 
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'           => array(
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Logo Header', THEMES_NAMES ), 
            'default'			=> false
        ),
        array(
            'id'				=>  'header_logo',
            'type'				=> 'media',
            'title'				=> __( 'Upload Your Header Logo', THEMES_NAMES ),
            'default'			=> array(
        ...
        array(
            'id'				=>  'aktif_favicon',
            'type'				=> 'switch',
            'title'				=> __( 'Enable Favicons', THEMES_NAMES ), 
            'default'			=> false
        ),
        array(
            'id'				=>  'favicon',
            'type'				=> 'media',
            'title'				=> __( 'Upload Favicon', THEMES_NAMES ),
            'default'			=> array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Statistic Codes', THEMES_NAMES ), 
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Footer Copyright', THEMES_NAMES ), 
            'default'			=> false
        ),
        array(
            ...
            'desc'				=> __( 'HTML Allowed', THEMES_NAMES ),
            'default'			=> "<a href='".get_option('home')."'>".get_option('blogname')."</a> - © <script type=\"text/javascript\">var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> All rights reserved - Developer by <a href=\"https://exthem.es\" title=\"premium wordpress themes - exthem.es\"><strong style=\"text-transform: capitalize;\">exthem.es</strong></a>",
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(			
			...
			'default'		=> '\'Didact Gothic\', sans-serif',		
			'desc'			=> __( '<i>*Default is</i>, <b style="color: crimson;">\'Didact Gothic\', sans-serif</b><br> Click Here To Get Font <a href="https://fonts.google.com/" target="_blank">fonts.google.com</a>', THEMES_NAMES ), 
			),
			array(
			'id'			=> 'font_body_link_custom',
			'type'			=> 'textarea',
			'title'			=> __( 'Url Link Fonts', THEMES_NAMES ),
			'default'		=> 'https://fonts.googleapis.com/css2?family=Didact+Gothic&display=swap',			 
			'desc'			=> __( '<i>*Default is</i>, <b style="color: crimson;">https://fonts.googleapis.com/css2?family=Didact+Gothic&display=swap</b><br> Click Here To Get Font <a href="https://fonts.google.com/" target="_blank">fonts.google.com</a>', THEMES_NAMES )
			),
			array(
            'id'				=> 'header_color',
            'type'				=> 'color',
            'title'				=> __('Background Header', THEMES_NAMES),
            'desc'				=> __('Pick Background Header Color for the theme (default: #008080).', THEMES_NAMES),
            'default'			=> '#008080',
            'validate'			=> 'color',
			),
			array(
            'id'				=> 'footer_color',
            'type'				=> 'color',
            'title'				=> __('Background Footer', THEMES_NAMES),
            'desc'				=> __('Pick Background Footer Color for the theme (default: #008080).', THEMES_NAMES),
            'default'			=> '#008080',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Color Link Url for the theme (default: #b823dd).', THEMES_NAMES),
            'default'			=> '#b823dd',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Color Link Hover for the theme (default: #9248E1).', THEMES_NAMES),
            'default'			=> '#9248E1',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Color Link Menu for the theme (default: #ffffff).', THEMES_NAMES),
            'default'			=> '#ffffff',
            'validate'			=> 'color',
			),
			array(
            'id'				=>  'color_text',
            'type'				=> 'color',
            'title'				=> __('Text Heading', THEMES_NAMES),
            'desc'				=> __('Pick Color Heading Text for the theme (default: #008080).', THEMES_NAMES),
            'default'			=> '#008080',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick SVG Icon Color for the theme (default: #9248E1).', THEMES_NAMES),
            'default'			=> '#9248E1',
            'validate'			=> 'color',
			),
			array(
            ...
            'desc'				=> __('Pick Social Icons Color for the theme (default: #b22222).', THEMES_NAMES),
            'default'			=> '#b22222',
            'validate'			=> 'color',
			),
			array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        array(
            ...
            'subtitle' => __( '', THEMES_NAMES ),
            'default'			=> __( 'Games and apps for Android', THEMES_NAMES )
        ),
        array(
            'id'				=>  'ex_themes_page_head_main_banner',
            'type'				=> 'media',
            'title'				=> __( 'Main Banner', THEMES_NAMES ),
            'default'			=> array(
                'url'=> ''.get_bloginfo('template_directory') . '/assets/img/main_illustration.png'),
        ),
        ...
        array(
            ...
            'subtitle' => __( '', THEMES_NAMES ),
            'default'			=> __( 'New games', THEMES_NAMES ),
            'required' => array( 'ex_themes_categorie_opt_1_activate', '=', true )
        ),
        array(
            'id'				=>  'categorie_opt_1',
            'type'				=> 'select',
            'data'     => 'category',
            'title'				=> __('Select Category for Opt 1 ', THEMES_NAMES),
            'required' => array( 'ex_themes_categorie_opt_1_activate', '=', true )
        ),
        array(
            'id'				=>  'categorie_opt_1_url',
            'type'				=> 'text',
            'title'				=> __( 'URL Opt 1', THEMES_NAMES ),
            'desc'				=> __( 'This must be a URL for showing more link', THEMES_NAMES ),
            //'validate'			=> 'url',
            'default'			=> ''.get_bloginfo('url').'/top-games/',
            'required' => array( 'ex_themes_categorie_opt_1_activate', '=', true )
        ),
        array(
            'id'				=>  'limit_categorie_opt_1',
            'type'				=> 'slider',
            'title'				=> __( 'How much to showing for Home', THEMES_NAMES ),
            "default"          => 6,
            "min"              => 2,
            "step"             => 1,
            "max"              => 20,
        ...
        array(
            'id'				=>  'ex_themes_categorie_opt_2_activate',
            'type'				=> 'switch',
            'title'				=> __( 'Enable Categorie Opt 2', THEMES_NAMES ),
            ////'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
            ...
            'type'				=> 'text',
            'title'				=> __( 'Title Categorie Opt 2', THEMES_NAMES ),
            'subtitle' => __( '', THEMES_NAMES ),
            'default'			=> __( 'New apps', THEMES_NAMES ),
            'required' => array( 'ex_themes_categorie_opt_2_activate', '=', true )
        ),
        array(
            'id'				=>  'categorie_opt_2',
            'type'				=> 'select',
            'data'     => 'category',
            'title'				=> __( 'Select Category for Option 2 Page', THEMES_NAMES),
            'required' => array( 'ex_themes_categorie_opt_2_activate', '=', true )
        ),
        array(
            'id'				=>  'categorie_opt_2_url',
            'type'				=> 'text',
            'title'				=> __('URL Opt 2', THEMES_NAMES),
            'desc'				=> __('This must be a URL for showing more link', THEMES_NAMES),
            //'validate'			=> 'url',
            'default'			=> ''.get_bloginfo('url').'/top-apps/',
            'required' => array( 'ex_themes_categorie_opt_2_activate', '=', true )
        ),
        array(
            'id'				=>  'limit_categorie_opt_2',
            'type'				=> 'slider',
            'title'				=> __( 'How much to showing for Home', THEMES_NAMES ),
            "default"          => 6,
            "min"              => 2,
        ...
        array(
            'id'				=>  'ex_themes_news_active_',
            'type'				=> 'switch',
            'title'				=> __( 'Enable News Home', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
            'id'				=>  'ex_themes_coms_active_',
            'type'				=> 'switch',
            'title'				=> __( 'Enable Comments Home', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ), 
		*/
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
       ...
       /*  array(
            'id'				=>  'ex_themes_view_post_',
            'type'				=> 'switch',
            'title'				=> __( 'Enable View Post', THEMES_NAMES ),
            'desc'				=> __( '<code>On</code> for Showing Total Views Read<br> <code>Off</code> for Hide Total Views Read', THEMES_NAMES ),
            'default'			=> false
        ), */
        array(
            ...
            'type'				=> 'text',
            'title'				=> __('Title Opt ', THEMES_NAMES),
            //'subtitle' => __('This must be a URL for showing more link', THEMES_NAMES),
            //'validate'			=> 'numeric',
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Screen Shots Image', THEMES_NAMES ),
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Random Youtube on inside content', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Help Menu', THEMES_NAMES ), 
            'default'			=> false
        ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        ...
        array(
            ...
            'desc'				=> __( '<code>ON</code> to showing download link from google play store', THEMES_NAMES ), 
            'default'			=> false
        ),
        array(
            ...
            'desc'				=> __( '<code>ON</code> to enable Ads Banner for Fake Link', THEMES_NAMES ), 
            'default'			=> false
        ),
		...
		*/
        array(
            ...
            'desc'				=> __( 'Enable Timer Counts ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Ads Banner for All Pages', THEMES_NAMES ),
            'desc'				=> __( '<br>ads banner for home, archive, categorie, search, 404 pages', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Ads Banner for only Homes', THEMES_NAMES ),
            'desc'				=> __( '<br>ads banner for homes', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Ads Banner for Single Post', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Ads Banner for Single Post Alternative', THEMES_NAMES ),
            //'subtitle' => __( '<br>ads banner for', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Ads Banner for Download Pages', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Ads Banner for Download Pages Alternative', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Webmaster Tools', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Socials Media', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
            ...
            //'subtitle' => __( 'This must be a URL.', THEMES_NAMES ),
            //'validate'			=> 'url',
        ...
        array(
            ...
            //'subtitle' => __( 'This must be a URL.', THEMES_NAMES ),
            //'validate'			=> 'url',
            'default'			=> 'https://www.youtube.com/channel/UCpcZNXk6ySLtwRSBN6fVyLA',
            'required' => array( 'ex_themes_social_media_sidebar_active_', '=', true )
        ),
        array(
            'id'				=>  'instagram_url',
...
Redux::setSection( $opt_name, array(
    'title'            => __( 'Inject Script or CSS', THEMES_NAMES ),
    'id'               => 'script_insert',
    'customizer_width' => '500px',
    'icon'             => 'el el-edit',
    'fields'     => array(
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Header Sections', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
        ...
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Footer Sections ', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
        array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable Thumbnails Google Play', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
            'id'				=>  'ex_themes_full_images_',
            'type'				=> 'switch',
            'title'				=> 'Enable Full Image Size',
			...
			'type'     => 'switch',
			'title'    => 'Hide Link',			
			'desc'		=> __( ' <b style="color: crimson;">Click <code>On</code> to Hide Url Link Download from copy paste</b>', THEMES_NAMES ), 
			'default'  => false
			),
        /* array(
                'id'				=>  'ex_themes_fake_view_active_',
                'type'				=> 'switch',
                'title'				=> __( 'Enable Fake Views', THEMES_NAMES ), 
                //'subtitle' => __( '<br> ', THEMES_NAMES ), 
                'default'			=> false
            ),
        array(
...
*/
        /*array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Enable CDN by WP.com', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
        array(
            'id'				=>  'ex_themes_classic_editor_activate_',
            'type'				=> 'switch',
            'title'				=> __( 'Enable editor classic ', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),*/  
		array(
            ...
            'type'				=> 'switch',
            'title'				=> 'Enable Scheme SEO MobileApplication',
            //'subtitle' => '*<i>only working for .apk link</i>',
            'default'			=> false
        ),
        /*array(
            ...
            'type'				=> 'switch',
            'title'				=> __( 'Add Defer & Async Attributes', THEMES_NAMES ),
            //'subtitle' => __( '<br> ', THEMES_NAMES ),
            'default'			=> false
        ),
         array(
...
Redux::setSection( $opt_name, array(
    ...
    'fields'     => array(
		...
		array(
			...
			'type'			=> 'text',
			'title'			=> __('Fonts Body', THEMES_NAMES),
			'default'		=> '\'Droid Arabic Kufi\', sans-serif',		
			'desc'			=> __( '<i>*Default is</i>, <b style="color: crimson;">\'Droid Arabic Kufi\', sans-serif</b><br> Click Here To Get Font <a href="https://fonts.google.com/" target="_blank">fonts.google.com</a>', THEMES_NAMES ), 
			...
			'type'			=> 'textarea',
			'title'			=> __( 'Url Link Fonts', THEMES_NAMES ),
			'default'		=> 'https://fonts.googleapis.com/earlyaccess/droidarabickufi.css',			 
			'desc'			=> __( '<i>*Default is</i>, <b style="color: crimson;">https://fonts.googleapis.com/earlyaccess/droidarabickufi.css</b><br> Click Here To Get Font <a href="https://fonts.google.com/" target="_blank">fonts.google.com</a>', THEMES_NAMES ),
			'required'		=> array( 'ex_themes_rtl_activate_', '=', true )
			),	 
			array(
			'id'				=>  'Languange_rtl',
