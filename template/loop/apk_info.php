<div class="view-app-data">
    <div class="specs-list">
		...
		$viewview = ex_themes_get_post_view_();
            ...
            <li class="specs-item">
                ...
                if ($terms) {
                    ...
                    foreach ($terms as $term) {
                        $output[] = '<span class="spec-cont"><a href="' .get_term_link( $term->slug, $developer) .'" title="Developer by ' .$term->name .'">' .$term->name .'</a></span>';
                    }
                    echo join( ', ', $output );	}
                ?>
            </li>
    ...
    <div class="view-app-rate">
        ...
        <ul class="rate-nums muted">
			...
			<?php global $opt_themes; if($opt_themes['ex_themes_view_post_']) { ?>
			<li><?php global $opt_themes; if($opt_themes['exthemes_apk_info_Views']) { ?><?php echo $opt_themes['exthemes_apk_info_Views']; ?><?php } ?> <?= ex_themes_get_post_view_(); ?></li> 
			<?php } ?>
        </ul>
    ...
    <div class="btn-group">
		...
		<a id="no-link" href="#" post-id="<?php echo $post->ID; ?>" class="report-post-link btn btn-lg btn-border "><span><?php global $opt_themes; if($opt_themes['exthemes_apk_info_Request_update']) { ?><?php echo $opt_themes['exthemes_apk_info_Request_update']; ?><?php } ?></span></a>
        <!--<button href="#"  post-id="<?php echo $post->ID; ?>" class="btn btn-lg btn-border needreg-btn" ><span>Request for update</span></button>
